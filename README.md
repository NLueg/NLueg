...
- **Microk8s Cluster 🤖**: A fully self-hosted Kubernetes cluster with automated CI/CD pipelines, leveraging GitHub Actions, Helm and ArgoCD for all my personal projects and microservices.
